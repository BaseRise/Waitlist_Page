...
import { CheckCircle2, Loader2, XCircle, Rocket, ArrowRight, ShieldCheck, Lock } from 'lucide-react'
      ...
      <AnimatePresence mode="wait">
            ...
            <div className="bg-[#0A0A0A]/90 rounded-[1.9rem] p-8 text-center h-full">
              ...
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  {isUpdating ? <Loader2 className="animate-spin" /> : <>Initialize Protocol <ArrowRight size={16} /></>}
                </span>
        ...
        {status === 'success' && (
          <motion.div
            ...
            className="relative z-10 max-w-md w-full p-8 text-center bg-black/40 backdrop-blur-xl rounded-[2rem] border border-green-500/20 shadow-[0_0_50px_-15px_rgba(34,197,94,0.2)]"
          >
            ...
            <h1 className="text-2xl font-black uppercase italic tracking-tight text-white mb-2">Spot Secured</h1>
        ...
        {status === 'already_verified' && (
          ...
          >
            ...
            <h1 className="text-2xl font-black uppercase italic tracking-tight text-white mb-2">Link Already Used</h1>
            <p className="text-gray-400 text-sm mb-6">You have already verified your spot.</p>
            <Link href="/" className="group text-blue-400 text-xs font-bold uppercase tracking-widest hover:text-blue-300 transition-all duration-300 border-b border-blue-500/30 hover:border-blue-400/50 pb-1 cursor-pointer inline-flex items-center gap-1">
              Return to Homepage
